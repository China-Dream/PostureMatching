...
namespace MathUtils {
    public struct Quaternion {
        ...
        public static Quaternion FromRotationMatrix(Matrix3D matrix) {
            ...
            double tr = matrix.M11 + matrix.M22 + matrix.M33;
            if (tr > 0)
            {
                double s = System.Math.Sqrt(1.0 + tr) * 2.0;
                w = s / 4;
            ...
            {
                double s = System.Math.Sqrt(1.0 + matrix.M11 - matrix.M22 - matrix.M33) * 2;
            ...
            {
                double s = System.Math.Sqrt(1.0 + matrix.M22 - matrix.M11 - matrix.M33) * 2;
            ...
            {
                double s = System.Math.Sqrt(1.0 + matrix.M33 - matrix.M11 - matrix.M22) * 2;
